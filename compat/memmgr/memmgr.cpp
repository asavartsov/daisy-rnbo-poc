...
// Modified by Calcitem (Calcitem <calcitem@outlook.com>)
//
...
void MemoryManager::memmgr_init(uint8_t *memory_pool, int pool_size)
{
...
void * MemoryManager::__builtin_memalign(int align, size_t len)
{
    ...
    newmem = (uint8_t *)(((uint64_t)mem + align - 1) & -align);
